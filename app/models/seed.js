...
const startSongs = [
    ...
    { title: 'Joy Introit', composer: 'Lil J. Cobb', lyricist: 'Lil J. Cobb', type: 'choral response', hymnNumber: 5, source: "Choral Responses",
    lyrics: 'Joy to the morning, Joy to the day, |Joy to all people going our way., |(Come let us worship) |Sweet joyful Spirit, O Spirit of love; |(Come let us worship) |Sweet joyful Spirit, O Spirit of love.  |We open our hearts: There\'s sunshine above, |So come and let us worship today.',
    scorePDF: 'CR5', recordings: {soprano: 'CR5_soprano', alto: 'CR5_alto', tenor: 'CR5_tenor', bass: 'CR5_bass', satb: 'CR5_satb', piano: 'CR5_piano'}, owner: '63019b25ae6e795c6c8e9eb7'},
    ...
    { title: 'Like a Bridge Over Troubled Water', composer: 'Simon and Garfunkel', lyricist: 'Simon and Garfunkel', type: 'Choral', source: "",
    lyrics: "[Verse 1]|``|When you're weary |Feeling small |When tears are in your eyes |I will dry them all |I'm on your side, oh |When times get rough |And friends just can't be found |``|[Chorus] |Like a bridge over troubled water |I will lay me down |Like a bridge over troubled water |I will lay me down |``|[Verse 2] |When you're down and out |When you're on the street |When evening falls so hard |I will comfort you |I'll take your part |When darkness comes |And pain is all around |``|[Chorus] |Like a bridge over troubled water |I will lay me down |Like a bridge over troubled water |I will lay me down", scorePDF: 'likeABridge', recordings: '', embedId: [''], owner: '63019b25ae6e795c6c8e9eb7'},
